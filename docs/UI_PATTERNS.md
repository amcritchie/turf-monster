...
- **Sidebar primitive** (`components/_sidebar_panel.html.erb`): fixed right panel using `--nav-h`, shared slide transitions, width `w-80`, and optional header actions / close / click-outside / Escape behavior.
