...
nfl_home_arenas = {
  "state-farm-stadium" => { name: "State Farm Stadium", location: "Glendale, AZ", city: "Glendale", state: "AZ", country: "USA", timezone: "America/Phoenix" },
  "mercedes-benz-stadium" => { name: "Mercedes-Benz Stadium", location: "Atlanta, GA", city: "Atlanta", state: "GA", country: "USA", timezone: "America/New_York" },
  "m-t-bank-stadium" => { name: "M&T Bank Stadium", location: "Baltimore, MD", city: "Baltimore", state: "MD", country: "USA", timezone: "America/New_York" },
  "highmark-stadium" => { name: "Highmark Stadium", location: "Orchard Park, NY", city: "Orchard Park", state: "NY", country: "USA", timezone: "America/New_York" },
  "bank-of-america-stadium" => { name: "Bank of America Stadium", location: "Charlotte, NC", city: "Charlotte", state: "NC", country: "USA", timezone: "America/New_York" },
  "soldier-field" => { name: "Soldier Field", location: "Chicago, IL", city: "Chicago", state: "IL", country: "USA", timezone: "America/Chicago" },
  "paycor-stadium" => { name: "Paycor Stadium", location: "Cincinnati, OH", city: "Cincinnati", state: "OH", country: "USA", timezone: "America/New_York" },
  "huntington-bank-field" => { name: "Huntington Bank Field", location: "Cleveland, OH", city: "Cleveland", state: "OH", country: "USA", timezone: "America/New_York" },
  "at-t-stadium" => { name: "AT&T Stadium", location: "Arlington, TX", city: "Arlington", state: "TX", country: "USA", timezone: "America/Chicago" },
  "empower-field-at-mile-high" => { name: "Empower Field at Mile High", location: "Denver, CO", city: "Denver", state: "CO", country: "USA", timezone: "America/Denver" },
  "ford-field" => { name: "Ford Field", location: "Detroit, MI", city: "Detroit", state: "MI", country: "USA", timezone: "America/New_York" },
  "lambeau-field" => { name: "Lambeau Field", location: "Green Bay, WI", city: "Green Bay", state: "WI", country: "USA", timezone: "America/Chicago" },
  "nrg-stadium" => { name: "NRG Stadium", location: "Houston, TX", city: "Houston", state: "TX", country: "USA", timezone: "America/Chicago" },
  "lucas-oil-stadium" => { name: "Lucas Oil Stadium", location: "Indianapolis, IN", city: "Indianapolis", state: "IN", country: "USA", timezone: "America/Indiana/Indianapolis" },
  "everbank-stadium" => { name: "EverBank Stadium", location: "Jacksonville, FL", city: "Jacksonville", state: "FL", country: "USA", timezone: "America/New_York" },
  "geha-field-at-arrowhead-stadium" => { name: "GEHA Field at Arrowhead Stadium", location: "Kansas City, MO", city: "Kansas City", state: "MO", country: "USA", timezone: "America/Chicago" },
  "sofi-stadium" => { name: "SoFi Stadium", location: "Inglewood, CA", city: "Inglewood", state: "CA", country: "USA", timezone: "America/Los_Angeles" },
  "allegiant-stadium" => { name: "Allegiant Stadium", location: "Las Vegas, NV", city: "Las Vegas", state: "NV", country: "USA", timezone: "America/Los_Angeles" },
  "hard-rock-stadium" => { name: "Hard Rock Stadium", location: "Miami Gardens, FL", city: "Miami Gardens", state: "FL", country: "USA", timezone: "America/New_York" },
  "u-s-bank-stadium" => { name: "U.S. Bank Stadium", location: "Minneapolis, MN", city: "Minneapolis", state: "MN", country: "USA", timezone: "America/Chicago" },
  "gillette-stadium" => { name: "Gillette Stadium", location: "Foxborough, MA", city: "Foxborough", state: "MA", country: "USA", timezone: "America/New_York" },
  "caesars-superdome" => { name: "Caesars Superdome", location: "New Orleans, LA", city: "New Orleans", state: "LA", country: "USA", timezone: "America/Chicago" },
  "metlife-stadium" => { name: "MetLife Stadium", location: "East Rutherford, NJ", city: "East Rutherford", state: "NJ", country: "USA", timezone: "America/New_York" },
  "lincoln-financial-field" => { name: "Lincoln Financial Field", location: "Philadelphia, PA", city: "Philadelphia", state: "PA", country: "USA", timezone: "America/New_York" },
  "acrisure-stadium" => { name: "Acrisure Stadium", location: "Pittsburgh, PA", city: "Pittsburgh", state: "PA", country: "USA", timezone: "America/New_York" },
  "lumen-field" => { name: "Lumen Field", location: "Seattle, WA", city: "Seattle", state: "WA", country: "USA", timezone: "America/Los_Angeles" },
  "levis-stadium" => { name: "Levi's Stadium", location: "Santa Clara, CA", city: "Santa Clara", state: "CA", country: "USA", timezone: "America/Los_Angeles" },
  "raymond-james-stadium" => { name: "Raymond James Stadium", location: "Tampa, FL", city: "Tampa", state: "FL", country: "USA", timezone: "America/New_York" },
  "nissan-stadium" => { name: "Nissan Stadium", location: "Nashville, TN", city: "Nashville", state: "TN", country: "USA", timezone: "America/Chicago" },
  "northwest-stadium" => { name: "Northwest Stadium", location: "Landover, MD", city: "Landover", state: "MD", country: "USA", timezone: "America/New_York" }
}
