...
#   - Resend/MoonPay are server-side only
#
...
Rails.application.configure do
  config.content_security_policy do |policy|
    ...
    policy.frame_src   :self, "https://js.stripe.com", "https://hooks.stripe.com", "https://*.moonpay.com", "https://buy.moonpay.com", "https://buy-sandbox.moonpay.com"
    policy.frame_ancestors :none   # clickjacking protection — we never embed in iframes
    policy.base_uri    :self
    policy.form_action :self, "https://checkout.stripe.com", "https://*.moonpay.com"
  end
