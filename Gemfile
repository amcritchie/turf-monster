...
gem "studio-engine", git: "https://github.com/amcritchie/studio-engine.git", tag: "v0.4.1"

# Solana primitives (Client, Keypair, Borsh, Transaction, AuthVerifier)
gem "solana-studio", git: "https://github.com/amcritchie/solana-studio.git", tag: "v0.4.1"
